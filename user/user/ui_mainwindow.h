...
"}"));
        ...
        verticalLayout->addWidget(but_friends);

        but_tool4 = new QPushButton(centralwidget);
        but_tool4->setObjectName("but_tool4");
        but_tool4->setMinimumSize(QSize(34, 40));
        but_tool4->setMaximumSize(QSize(34, 40));
        but_tool4->setStyleSheet(QString::fromUtf8("QPushButton:hover {\n"
"background-color: rgb(255, 170, 255); \n"
"}\n"
""));

        verticalLayout->addWidget(but_tool4);
...
"    background-color: rgba(0, 0, 0, 0.2); \n"
"}"));
        QIcon icon6(QIcon::fromTheme(QString::fromUtf8("QIcon::ThemeIcon::FolderNew")));
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        but_tool4->setText(QCoreApplication::translate("MainWindow", "AI", nullptr));
